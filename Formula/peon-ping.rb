class PeonPing < Formula
  ...
  url "https://github.com/PeonPing/peon-ping/archive/refs/tags/v2.34.0.tar.gz"
  sha256 "ad3fa9cf8392ce52263eba5420c16d7b5369d2a0c837d9f2d20976c1af7198aa"
  license "MIT"
  ...
  def install
    ...
    (bin/"peon-ping-setup").write <<~EOS
      ...
      if [ "$HAS_CLAUDE" = true ]; then
        ...
        [ -f "$LIBEXEC/completions.zsh" ] && ln -sf "$LIBEXEC/completions.zsh" "$INSTALL_DIR/completions.zsh"
      ...
      if [ "$HAS_ROVODEV" = true ]; then
        ...
        # Find config file (config.yml or config.yaml) for summary output
